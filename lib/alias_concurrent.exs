...
tasks = [
  Task.async(fn -> ESAliases.IndexManagement.AliasConcurrent.run("test_index") end) | tasks
]

tasks = [
  Task.async(fn -> ESAliases.IndexManagement.AliasConcurrent.run("test_index2") end) | tasks
]
